...
//$startDate = mysqli_real_escape_string($con, $data->startDate);
 ...
 // if(isset($Selected_Year)){
 	...
 	$query = "SELECT subactivities.Title,subactivities.Coding, mainactivities.Division,
 					subactivities.idsubactivities
				FROM subactivities JOIN mainactivities
				ON subactivities.idMainActivities = mainactivities.idMainActivities
				WHERE mainactivities.yr = '$Selected_Year' and subactivities.deleted = 0 ORDER BY subactivities.date_encoded DESC";
