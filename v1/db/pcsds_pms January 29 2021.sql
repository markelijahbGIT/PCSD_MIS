...
(27, '7', 3, NULL, '5', '', '2019-FOI-Reports (1).pdf', '2021-01-28', '2021-01-29', 'unconfirmed', '');
...
(1, 5, '', 'save Accomplishment', '2021-01-28 00:00:00', ''),
(2, 5, '', 'save Accomplishment', '2021-01-28 00:00:00', ''),
(3, 5, '', 'save Accomplishment', '2021-01-28 00:00:00', ''),
(4, 5, '', 'save Accomplishment', '2021-01-28 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(3,6,,5,download (3).xls,2021-01-20,2021-01-28 15:43:34)'),
(5, 1, '', 'Create Main Activity', '2021-01-28 00:00:00', 'INSERT into mainactivities\r\n(Title,MFONo,yr, date_encoded) \r\n\r\nVALUES \r\n\r\n(GAS,General Administrative Services,2021,2021-01-28 16:03:41)'),
(6, 1, '', 'Create Main Activity', '2021-01-28 00:00:00', 'INSERT into mainactivities\r\n(Title,MFONo,yr, date_encoded) \r\n\r\nVALUES \r\n\r\n(QWERTy,General Administrative Services,2021,2021-01-28 16:16:15)'),
(7, 0, '', 'Create Main Activity', '2021-01-28 00:00:00', ''),
(8, 0, '', 'Create Main Activity', '2021-01-28 00:00:00', ''),
(9, 1, '', 'Create Main Activity', '2021-01-28 00:00:00', ''),
(10, 1, '', 'Create Main Activity', '2021-01-28 00:00:00', ''),
(11, 1, '', 'Create Main Activity', '2021-01-28 00:00:00', 'INSERT into subactivities\r\n(Title,idMainActivities, date_encoded) \r\n\r\nVALUES \r\n\r\n(Subsub,4,2021-01-28 16:42:48)'),
(12, 1, '', 'Save SubActivity', '2021-01-28 00:00:00', 'INSERT into subactivities\r\n(Title,idMainActivities, date_encoded) \r\n\r\nVALUES \r\n\r\n(Subsub,4,2021-01-28 16:49:48)'),
(13, 5, '', 'Save Accomplishment', '2021-01-28 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(12,12,,5,FOI-SRI.xlsx,2021-01-27,2021-01-28 16:51:48)'),
(14, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(43,8,,5,pcsds_accounting_is Jan 14.zip,2021-01-26,2021-01-29 09:47:37)'),
(15, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(43,8,,5,pcsds_accounting_is Jan 14.zip,2021-01-26,2021-01-29 09:48:04)'),
(16, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(43,8,,5,pcsds_accounting_is Jan 14.zip,2021-01-26,2021-01-29 09:48:28)'),
(17, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(34,7,,5,pcsds_accounting_is Jan 14.sql,2021-01-28,2021-01-29 11:15:44)'),
(18, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(45,10,,5,pcsds_pms Jan 28 2021.sql,2021-01-20,2021-01-29 12:57:06)'),
(19, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(465,10,,5,pcsds_pms January 26 2021.sql,2021-01-13,2021-01-29 13:00:02)'),
(20, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(35,12,,5,book.sql,2021-01-22,2021-01-29 13:01:31)'),
(21, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(433,10,,5,2020-FOI (1).xlsx,2021-01-05,2021-01-29 13:02:23)'),
(22, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(1,8,,5,136131463_1008558932966415_7981184814825278387_n.jpg,2021-01-07,2021-01-29 13:03:27)'),
(23, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(1,9,,5,FOI_Inventory_of_Information_PCSDS_FINAL2.xlsx,2021-01-05,2021-01-29 13:32:22)'),
(24, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(1,9,,5,FOI_Inventory_of_Information_PCSDS_FINAL2.xlsx,2021-01-05,2021-01-29 13:32:34)'),
(25, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(1,8,,5,FOI_Inventory_of_Information_PCSDS_FINAL2.xlsx,2021-01-05,2021-01-29 13:33:40)'),
(26, 5, '', 'Submitted Accomplishment', '2021-01-29 00:00:00', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(1,8,,5,FOI_Inventory_of_Information_PCSDS_FINAL2.xlsx,2021-01-14,2021-01-29 13:35:09)'),
(27, 5, '', 'Submitted Accomplishment', '2021-01-29 15:15:07', 'INSERT into accomplished\r\n(quantity,idindicators,remarks,user,fileName,dateCompleted,dateEncoded) \r\n\r\nVALUES \r\n\r\n(3,7,,5,2019-FOI-Reports (1).pdf,2021-01-28,2021-01-29 15:15:07)');
...
INSERT INTO `notifications` (`notifications_id`, `record_id`, `user_id`, `db_name`, `seen`, `notif_text`, `date_created`, `date_seen`) VALUES
(1, '16', 5, 'accomplished', 0, 'Submitted Accomplishment', '2021-01-29 00:00:00', '0000-00-00'),
(2, '16', 5, 'accomplished', 0, 'Submitted Accomplishment', '2021-01-29 00:00:00', '0000-00-00'),
(3, '17', 5, 'accomplished', 0, 'Submitted Accomplishment', '2021-01-29 00:00:00', '0000-00-00'),
(4, '18', 5, 'accomplished', 0, 'Submitted Accomplishment', '2021-01-29 00:00:00', '0000-00-00'),
(5, '19', 5, 'accomplished', 0, 'Submitted Accomplishment', '1970-01-01 00:00:00', '0000-00-00'),
(6, '20', 5, 'accomplished', 0, 'Submitted Accomplishment', '2021-01-29 00:00:00', '0000-00-00'),
...
(21, 1, NULL, 'Field Validation', 'Number of field validation reports prepared', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, '', 'ECAN Zoning', ''),
(22, 3, NULL, 'Consultation Workshop (Post-Field Validation)', 'Number of consultations documented with reports prepared', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, '', 'ECAN Zoning', 'EEED'),
(23, 4, NULL, 'Presentation to the ECAN Board', 'Number of ECAN maps presented and updated', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, 'DBM,DENR,OPCR', 'ECAN Zoning', 'EEED'),
(24, 6, NULL, 'Assistance to LGU on Critical Watershed Assessment and Management Planning supporting water systems', 'Number of management frameworks for critical watershed developed', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, '', 'ECAN Zoning', 'EPRPD'),
(25, 7, NULL, 'Socio-cultural and Ecological Studies of ICCA', 'Number of ICCA studies undertaken', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, '', 'ECAN Zoning', 'EPRPD'),
(26, 8, NULL, 'Administration of ECAN Zones Scorecard', 'Number of reports on ECAN Zones Scorecard prepared', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, 'DBM,DENR', 'ECAN Zoning', 'EPRPD'),
(27, 9, NULL, 'Capacity Building of Stakeholders on ECAN and sustainable development planning', 'Number of presentations given on ECAN and sustainable development planning', '1', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, '', 'ECAN Zoning', 'EPRPD'),
(28, 10, NULL, 'Attendance to Training, Workshops, and Conferences', 'Percentage of attendance to trainings, workshops, and conferences with reports issued to officials concerned', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, '', 'ECAN Zoning', 'EPRPD'),
(29, 11, NULL, 'Attendance to Official Meetings', 'Percentage of attendance to official meetings with reports issued to officials concerned', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, '', 'ECAN Zoning', 'EPRPD'),
(30, 12, NULL, 'Conduct of In-House Planning Workshops', 'Number of in-house workshops organized or facilitated', '', '0', '0.00', '0', '0.00', '-100.00', NULL, 2020, '', 'ECAN Zoning', 'EPRPD');
...
(2998, 0, NULL, NULL, NULL, '1', '1', NULL, NULL, NULL, NULL, NULL, '1', 0),
(2999, 0, NULL, NULL, NULL, '0', '1', NULL, NULL, NULL, NULL, NULL, '2', 0),
(3000, 0, NULL, NULL, NULL, '0', '1', NULL, NULL, NULL, NULL, NULL, '3', 0),
(3001, 0, NULL, NULL, NULL, '1', '2', NULL, NULL, NULL, NULL, NULL, '4', 0),
(3002, 0, NULL, NULL, NULL, '0', '1', NULL, NULL, NULL, NULL, NULL, '5', 0),
(3003, 0, NULL, NULL, NULL, '0', '202', NULL, NULL, NULL, NULL, NULL, '6', 0),
(3004, 0, NULL, NULL, NULL, '0', '1', NULL, NULL, NULL, NULL, NULL, '7', 0),
(3005, 0, NULL, NULL, NULL, '0', '1', NULL, NULL, NULL, NULL, NULL, '8', 0),
(3006, 0, NULL, NULL, NULL, '0', '5', NULL, NULL, NULL, NULL, NULL, '9', 0),
(3007, 0, NULL, NULL, NULL, '0', '2', NULL, NULL, NULL, NULL, NULL, '10', 0),
(3008, 0, NULL, NULL, NULL, '0', '2', NULL, NULL, NULL, NULL, NULL, '11', 0),
(3009, 0, NULL, NULL, NULL, '0', '205', NULL, NULL, NULL, NULL, NULL, '12', 0);
...
--
ALTER TABLE `accomplished`
  MODIFY `idaccomplished` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `audit_trail`
--
ALTER TABLE `audit_trail`
  MODIFY `audit_trail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `notifications`
  MODIFY `notifications_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `report`
--
ALTER TABLE `report`
  MODIFY `idreport` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `report_monthly`
--
ALTER TABLE `report_monthly`
  MODIFY `idreport` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3013;
